...
import style from './Profile6.module.css';
import { transactProfile6 } from "../../API";
...
const Profile6 = (props) => {
    const {searchInput,ref6,setTransObj} =props;
    const [profile, setProfiles] = useState([]);

  var prfArr = [];

  const retrieve = async () => {
    setProfiles(await transactProfile6());
  };
  ...
  return (
    <section ref={ref6} className={style.container}>
